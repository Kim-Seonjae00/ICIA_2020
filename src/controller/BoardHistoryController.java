...
@WebServlet("/boardHistory")
public class BoardHistoryController extends HttpServlet {
    ...
    protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	RequestDispatcher dispatch = request.getRequestDispatcher("BoardHistory.jsp");

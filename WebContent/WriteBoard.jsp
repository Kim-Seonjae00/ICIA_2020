...
<body>
	...
	<div id="main_write">
		<form action="writeBoard?mId=${sessionScope.mId}" method="post" enctype="multipart/form-data" name="writeBoardForm">
			...
			<tr>
				...
				<td>
					<input type="text" name="boTitle" class="writeRequired blank_ch">
				</td>
			</tr>
			<tr>
				<td class="category">
				...
				<td style="background-color:white">
					<textarea cols="50" rows="10" name="comments" class="writeRequired2 blank_ch"></textarea>
				</td>
			</tr>	
			</table>
			<img id="image_section" src="#" alt="your image" style="width:200px; height:150px;visibility:hidden;">
			<input type="file" name="bFiles" id="imgInput"><br>
			
		</form>
		<button onclick="writeBoardSubmit()">작성</button>
	</div>
</body>
</html>